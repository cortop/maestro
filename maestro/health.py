...
CHECKS = (check_heartbeat, check_backup_age, check_claim_age, check_claim_no_output,
          ...
          check_spawn_floor, check_daily_spend, check_gh_credential_reachability, check_launchctl,
          check_ollama_models, check_runner_binary, check_worktree_health, check_provider_availability)
